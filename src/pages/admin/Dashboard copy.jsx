...
const Dashboard = () => {
  ...
  const stats = [
    ...
    { title: "Revenus", value: "24,599XOF", icon: <FaChartLine className="text-2xl" />, color: "bg-purple-100 text-purple-600" },
  ];
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {recentProducts.map(product => (
                <tr key={product.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{product.price}XOF</td>
