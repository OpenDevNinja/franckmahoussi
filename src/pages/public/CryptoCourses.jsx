...
const CryptoCourses = () => {
  ...
  useEffect(() => {
    document.title = "Formations Crypto | EliteShop";
    window.scrollTo(0, 0);
  }, [location]);
  ...
  return (
    <div className="py-12 bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-4xl font-bold mb-4">Formations Cryptomonnaies</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Maîtrisez les cryptomonnaies avec nos formations expertes adaptées à tous les niveaux.
          </p>
        </motion.div>
